...
The mean steps per day is `r as.integer(round(m,0))` and the median is `r md`.
...
the average steps per day, `r as.integer(round(m,0))`, which falls in the middle bar.  So all 8 days got added to the middle
